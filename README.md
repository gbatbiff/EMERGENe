...
|---|---|---:|---|
| `-tree <tree_file>` | Path | — | Path to the phylogenetic tree file. |
| `-amr <amr_table_file>` | Path | — | Path to the AMR table generated by **AMRFinderPlus**. |
...
| `-nsim <integer>` | Integer | `100` | Number of stochastic simulations used for ancestral state reconstruction. |
